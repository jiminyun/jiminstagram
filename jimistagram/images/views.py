...
from jimistagram.users import serializers as user_serializers
from jimistagram.users import models as user_models
from jimistagram.notifications import views as notification_views
...
class UnLikeImage(APIView):
    ...
    def delete(self, request, image_id, format=None):
        ...
        try:
            ...
            return Response(status=status.HTTP_3_NOT_MODIFIED)
