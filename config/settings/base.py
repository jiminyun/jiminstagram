...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///jiminstagram'),
}
...
MIGRATION_MODULES = {
    'sites': 'jimistagram.contrib.sites.migrations'
}
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = 'jimistagram.users.adapters.AccountAdapter'
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = 'jimistagram.users.adapters.SocialAccountAdapter'
